...
const Watched = () => {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      {watched.map((movie) => (
        <div key={movie.id} style={{ display: 'flex', overflow: 'hidden', borderRadius: 18, border: '1px solid #2d2d2d', background: '#1d1d1e', marginBottom: 10, transition: 'transform 0.2s' }}
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', padding: 14 }}>
            ...
            <div style={{ marginTop: 14 }}>
              <button
                ...
                style={{ flex: 1, width: '100%', height: 34, background: '#111827', color: '#fff', border: '1px solid #111827', borderRadius: 10, cursor: 'pointer', fontSize: 12, fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}
              >
